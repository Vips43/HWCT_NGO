    ...
    <article className="p-4 rounded-lg shadow-sm cursor-default flex flex-col justify-between bg-main-bg-200">
      <div className="flex flex-col items-center gap-4">
        <div
          ...
          className="p-4 aspect-square rounded-full bg-main-bg-600/70"
        >
          <Icon size={28} />
        </div>
      ...
      <button
        type="button"
        className="px-3 py-2 mt-8 bg-main-bg-600 text-main-bg-50 cursor-pointer rounded-xl font-semibold transition-all duration-300"
